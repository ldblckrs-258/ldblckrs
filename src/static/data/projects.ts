...
const PROJECTS : Project[] = [
  {
    id: "medicalink-microservice",
    logo: "/circle.svg",
    title: "MedicaLink Microservices",
    time: "09.2025 - 12.2025",
    link: "https://github.com/ldblckrs-258/medicalink-microservice",
    tags: [
      "Team Project",
      "Backend Development",
      "NestJS",
    ...
    description: "A microservices-based medical appointment booking system with 7 independent services communicating via RabbitMQ.\n- Features:\n\t- API Gateway with Backend for Frontend pattern\n\t- Authentication with JWT, RBAC permissions\n\t- Doctor profiles, specialties, scheduling management\n\t- Appointment booking and patient management\n\t- Blog, Q&A platform, and doctor reviews\n\t- Email notifications with queue management\n\t- Saga orchestration for cross-service coordination\n- Technologies:\n\t- NestJS framework with TypeScript\n\t- PostgreSQL with schema-level separation via Prisma ORM\n\t- RabbitMQ for inter-service communication (RPC & event-driven)\n\t- Redis for caching and queue management\n\t- Docker & Docker Compose for deployment",
  },
  {
    id: "novel-studio",
    logo: "/circle.svg",
    ...
    link: "https://novel-studio-kappa.vercel.app",
    tags: [
      "Personal Project",
    ...
    description: "A local-first creative writing workspace built for Vietnamese writers and translators. All data lives in the browser with no account required.\n- Features:\n\t- Local-first data storage with IndexedDB, optional encrypted backup and cross-device sync\n\t- Multi-provider AI chat (OpenAI, Anthropic, Google, Groq, etc.) with context-aware novel understanding\n\t- Three-phase analysis and six-step auto-writing pipeline\n\t- Chinese → Vietnamese translation with QT dictionaries and name detection\n\t- Text-to-Speech reader with sentence highlighting\n\t- Web scraper for importing chapters from novel sites\n\t- WebGPU inference for local model execution in the browser\n- Technologies:\n\t- Next.js 16 with React 19 and TypeScript\n\t- Tailwind CSS 4 + shadcn/ui for styling\n\t- Dexie 4 (IndexedDB) for local-first data\n\t- Vercel AI SDK v6 for multi-provider AI integration\n\t- Zustand 5 for state management",
  },
  {
